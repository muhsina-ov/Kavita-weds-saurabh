    ...
    >
      ...
      >
        ...
        <div className="relative flex h-full flex-col items-center justify-center px-10 text-center">
          ...
          <p className="caps mt-3 text-[0.5rem] text-olive/80">
          ...
          <p className="caps mt-2 text-[0.44rem] text-sepia/50">{invite.venue.city}</p>
        </div>
      </div>
    ...
    <AnimatePresence>
      {state !== "gone" && (
        ...
        >
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      ...
                      clipPath:
                        "polygon(28% 0, 72% 0, 100% 100%, 78% 84%, 50% 100%, 22% 84%, 0 100%)",
                      opacity: 0.55,
                    }}
                  />
          ...
          {state === "breaking" && !reduced && <PetalBurst count={44} spread={340} seed={3} />}
        </motion.div>
      )}
    </AnimatePresence>
  );
